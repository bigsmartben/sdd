...
def test_command_mapping_documents_authority_model():
    ...
    assert "| `.specify/memory/repository-first/*` | Canonical repository-first dependency/invocation projections | Authoritative |" in content
...
def test_constitution_template_declares_repo_anchor_whitelist_and_blacklist():
    ...
    assert "invocation governance MUST derive from real module/source anchors" in constitution
