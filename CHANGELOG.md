...
- Add `/sdd.plan ... ALL` autonomous-mode guidance while preserving queue-order semantics and first-blocker stop behavior
...
- Publish patch release `2.0.12` from `main` after merge of PR #16 (`feat/repository-first-planning-docs-5eec3e2`), including repository-first planning docs and aligned template/test updates.
