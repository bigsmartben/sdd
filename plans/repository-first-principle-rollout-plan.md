...
结合现有 [`Repo-Anchor Evidence Protocol`](.specify/memory/constitution.md:133)，建议把仓库优先落实为四条硬规则。
...
建议把 [`.specify/memory/constitution.md`](.specify/memory/constitution.md:133) 中的 [`Repo-Anchor Evidence Protocol`](.specify/memory/constitution.md:133) 收敛增强为下面这组短规则：
...
在 [`.specify/memory/constitution.md`](.specify/memory/constitution.md:133) 的 [`Repo-Anchor Evidence Protocol`](.specify/memory/constitution.md:133) 中补充三件事：
...
- [ ] 收敛 [`.specify/memory/constitution.md`](.specify/memory/constitution.md:133) 的仓库优先规则，固定三类分析目标与两类证据来源
...
1. 先修改 [`.specify/memory/constitution.md`](.specify/memory/constitution.md:133)
