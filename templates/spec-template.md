...
- [Optional checklist] Run `/sdd.checklist <path/to/plan.md>` when needed to generate `checklists/*.md` as vertical checklist output (not a main-flow artifact)
...
If checklist-style validation is needed, generate it separately with `/sdd.checklist <path/to/plan.md>` as a vertical artifact in `checklists/*.md`.
