...
- [plan.md](plan.md) (generated by `/sdd.plan`)
- Optional planning artifacts (depending on feature complexity):
  - `research.md`
  - `data-model.md`
  - `contracts/`
  - `test-matrix.md`
...
- [Optional audit] `/sdd.analyze` reviews `spec.md`, `plan.md`, and `tasks.md` before `/sdd.implement`
