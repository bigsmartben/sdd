...
4. **Run the planning workflow as a context-minimized loop**:
...
5. **Execute stages in fixed order with stage-local reads**:
...
6. **Stop and report**: End after Stage 4. Report the branch, `plan.md` path, and generated artifacts.
