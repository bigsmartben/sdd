...
SKILL_DESCRIPTIONS = {
    ...
    "checklist": "Generate custom quality checklists for validating requirements completeness and clarity from the current feature branch plan.md. Use `/sdd.checklist` to create unit tests for English as a standalone vertical pass.",
...
def init(
    ...
    enhancement_lines = [
        ...
        f"○ [cyan]/{COMMAND_NAMESPACE}.checklist[/] [bright_black](optional)[/bright_black] - Generate quality checklists to validate requirements completeness, clarity, and consistency from the active feature branch plan"
    ]
